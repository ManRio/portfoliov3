      ...
      <section className='min-h-screen bg-transparent text-white px-6 py-20'>
        ...
        >
          ...
          <div className='text-center font-code text-lg leading-relaxed'>
            <p>
              Proyecto de desarrollo de una landing page completamente
              responsive. Creado para fortalecer habilidades de diseño moderno
              usando <strong>HTML5</strong>, <strong>CSS3</strong> y{' '}
