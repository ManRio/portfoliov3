    ...
    <section className='min-h-screen bg-transparent text-white px-6 py-20'>
      ...
      >
        ...
        <p className='text-lg text-center font-code leading-relaxed'>
          <b>ORO Manager</b> es una plataforma web integral desarrollada durante
          las prácticas FCT para gestionar empleados dentro de una organización.
          Incorpora módulos como tareas generales, recompensas, formación,
          documentos, chat en tiempo real y recursos de IA, con enfoque en
          usabilidad, rendimiento y diseño responsive.
        </p>
